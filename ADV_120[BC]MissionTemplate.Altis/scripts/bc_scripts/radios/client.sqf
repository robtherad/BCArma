...
switch (groupID (group player)) do {
	...
	case "D SL": { ch2 = playerBaseChannel + 4; ch3 = playerBaseChannel + 4.1; ch4 = playerBaseChannel + 4.2; curChan = 2; altChan = 1;};
	...
	case "H SL": { ch2 = playerBaseChannel + 4; ch3 = playerBaseChannel + 4.1; ch4 = playerBaseChannel + 4.2; curChan = 2; altChan = 1;};
...
if (_side == west) then {
	radioNoteString = radioNoteString + "<font size='24'>Default Radio Frequency List</font><br/><br/>" + "Plt. HQ - " + str(playerBaseChannel) + " MHz<br/><br/>" + "Alpha Squad - " + str(playerBaseChannel + 1) + " MHz<br/>" + "Alpha One - " + str(playerBaseChannel + 1.1) + " MHz<br/>" + "Alpha Two - " + str(playerBaseChannel + 1.2) + " MHz<br/><br/>" + "Bravo Squad - " + str(playerBaseChannel + 2) + " MHz<br/>" + "Bravo One - " + str(playerBaseChannel + 2.1) + " MHz<br/>" + "Bravo One - " + str(playerBaseChannel + 2.2) + " MHz<br/><br/>" + "Charlie Squad - " + str(playerBaseChannel + 3) + " MHz<br/>" +"Charlie One - " + str(playerBaseChannel + 3.1) + " MHz<br/>" + "Charlie One - " + str(playerBaseChannel + 3.2) + " MHz<br/><br/>" + "Delta Squad - " + str(playerBaseChannel + 4) + " MHz<br/>" +"Delta One - " + str(playerBaseChannel + 4.1) + " MHz<br/>" + "Delta Two - " + str(playerBaseChannel + 4.2) + " MHz<br/>" + "Delta Three - " + str(playerBaseChannel + 4.3) + " MHz<br/>" + "Delta Four - " + str(playerBaseChannel + 4.4) + " MHz<br/>";
} else {
	radioNoteString = radioNoteString + "<font size='24'>Default Radio Frequency List</font><br/><br/>" + "Plt. HQ - " + str(playerBaseChannel) + " MHz<br/><br/>" + "Echo Squad - " + str(playerBaseChannel + 1) + " MHz<br/>" + "Echo One - " + str(playerBaseChannel + 1.1) + " MHz<br/>" + "Echo Two - " + str(playerBaseChannel + 1.2) + " MHz<br/><br/>" + "Foxtrot Squad - " + str(playerBaseChannel + 2) + " MHz<br/>" + "Foxtrot One - " + str(playerBaseChannel + 2.1) + " MHz<br/>" + "Foxtrot One - " + str(playerBaseChannel + 2.2) + " MHz<br/><br/>" + "Golf Squad - " + str(playerBaseChannel + 3) + " MHz<br/>" + "Golf One - " + str(playerBaseChannel + 3.1) + " MHz<br/>" + "Golf One - " + str(playerBaseChannel + 3.2) + " MHz<br/><br/>" + "Hotel Squad - " + str(playerBaseChannel + 4) + " MHz<br/>" + "Hotel One - " + str(playerBaseChannel + 4.1) + " MHz<br/>" + "Hotel Two - " + str(playerBaseChannel + 4.2) + " MHz<br/>" + "Hotel Three - " + str(playerBaseChannel + 4.3) + " MHz<br/>" + "Hotel Four - " + str(playerBaseChannel + 4.4) + " MHz<br/>";
};
