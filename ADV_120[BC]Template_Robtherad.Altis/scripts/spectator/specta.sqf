...
spectate_events = compile preprocessFile "scripts\spectator\specta_events.sqf";
RefreshPlayerList = compile preprocessFile "scripts\spectator\RefreshPlayerList.sqf";
FreeLookMovementHandler = compile preprocessFile "scripts\spectator\FreeLookMovementHandler.sqf";
CameraMenuHandler = compile preprocessFile "scripts\spectator\CameraMenuHandler.sqf";
PlayerMenuHandler = compile preprocessFile "scripts\spectator\PlayerMenuHandler.sqf";
KEGsShowCombatMode = compile preprocessFile "scripts\spectator\specta_combatmode.sqf";
KEGsShowUnitLocator = compile preprocessFile "scripts\spectator\specta_locator.sqf";
